...
function LoginFormPage() {
  ...
  return (
    <div className="login__form-wrapper">
      ...
      <img className="splash__image--background" alt="background-login" src="https://images.unsplash.com/photo-1509440159596-0249088772ff?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=752&q=80" ></img>
